...
model_file=/mnt/data2/bhanu/code-bases/ppg-vc/ckpt/convpos_spkloss2_8020/best_spk_loss_step_565000.pth
...
# ref_wav_path=/mnt/data2/bhanu/datasets/all_data_for_ac_vc/YKWK/wav/arctic_a0001.wav
echo ${config}
...
#   ref_wav_path="/home/shaunxliu/data/cmu_arctic/cmu_us_slt_arctic/wav/arctic_a0001.wav"
  ...
  python convert_from_wav_transformer.py \
